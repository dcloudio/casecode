...
if (ENVIRONMENT_IS_NODE) {
  var fs = require('fs');
  Module['wasm'] = fs.readFileSync(__dirname + '/cmark-gfm-md2json.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  _get_output_length = wasmExports['get_output_length'];
  _free_output_buffer = wasmExports['free_output_buffer'];
  _init_cmark_gfm = wasmExports['init_cmark_gfm'];
  _md2json = wasmExports['md2json'];
